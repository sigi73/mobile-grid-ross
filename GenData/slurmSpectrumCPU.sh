...
mpirun --bind-to core --report-bindings -hostfile /tmp/hosts.$SLURM_JOB_ID -np $SLURM_NPROCS /gpfs/u/home/PCP9/PCP9srsd/barn/Final/ROSS/build_cpu/models/mobile-grid-ross/mobile_grid "$@"
